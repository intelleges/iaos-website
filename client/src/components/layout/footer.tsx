        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/product" className="text-sm font-light text-muted-foreground hover:text-foreground transition-colors">
                  Overview
                </Link>
              </li>
              <li>
                <Link href="/protocols" className="text-sm font-light text-muted-foreground hover:text-foreground transition-colors">
                  Protocols
                </Link>
              </li>
              <li>
                <Link href="/supplier-onboarding" className="text-sm font-light text-muted-foreground hover:text-foreground transition-colors">
                  Supplier Onboarding
                </Link>
              </li>
              <li>
          ...
          {/* Resources */}
          <div className="space-y-4">
            <h3 className="text-sm font-normal">Resources</h3>
            <ul className="space-y-3">
              <li>
                <Link href="/case-studies" className="text-sm font-light text-muted-foreground hover:text-foreground transition-colors">
                  Case Studies
                </Link>
              </li>
              <li>
                <Link href="/resources" className="text-sm font-light text-muted-foreground hover:text-foreground transition-colors">
                  Whitepapers
                </Link>
              </li>
            </ul>
          ...
          {/* Login */}
          <div className="space-y-4">
            <h3 className="text-sm font-normal">Access</h3>
            <ul className="space-y-3">
              <li>
